...
/*
 * Database connection constants configure here the database connection.
 * !!! Change the values below to match your needs !!!
 * Change only username and password if you are on a IUT computuer
 * Change also host and port if you are on you computer to match your configuraiton
 */
const DB_DRIVER = 'mysql'; // pgsql pour les machines IUT
const DB_HOST = 'localhost'; // servbdd.iutlan.etu.univ-rennes1.fr pour les machines IUT
const DB_PORT = 3306; // 5433 pour les machines IUT
const DB_USERNAME = 'root'; // votre login linux pour les machines IUT
const DB_PASSWORD = ''; // votre mdp linux pour les machines IUT
const DB_DATABASE = 'sae203'; // pg_VOTRELOGIN pour les machines IUT


const CHEMIN_URL_SERVER = 'http://localhost/SAE203-ALEX/'; // Chemin de l'adresse où le serveur écoute
